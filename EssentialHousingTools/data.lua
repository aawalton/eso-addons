...
--[[
	...
	EHT.SavedVars.Kiosks = nil

	local allKiosks = EHT.SavedVars.Kiosks2
	if not allKiosks then
		allKiosks = { }
		EHT.SavedVars.Kiosks2 = allKiosks
	end

	local houseKiosks = allKiosks[houseId]
	if not houseKiosks then
		houseKiosks = { }
		allKiosks[houseId] = houseKiosks
	end

	local kiosk = houseKiosks[filter]
	if not kiosk then
		kiosk = { }
		houseKiosks[filter] = kiosk
	end
]]
	local kiosk = { }
