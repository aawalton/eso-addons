...
-- add this table to data/MiscItemSources.lua, or create an own file.
-- Warning: If you do that, you need to register it in FurnitureCatalogue.txt
...
-- add one subtable per item source that you want to register. Empty tables will be ignored when filtering.
