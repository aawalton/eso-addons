...
lib.data[100035] = 
{
	...
	[2] = 
	{
		...
		[82] = 
		{
			...
			["d"] = 
			{
				["de"] = "Diese Buchfragmente ermöglichen die Herstellung von Gegenständen im Stil der Totenländer-Gladiatoren.",
				["ru"] = "Страницы этой книги позволяют создавать предметы в стиле гладиатора из Мертвых Земель.",
				["en"] = "These book fragments enable crafting in the Deadlands Gladiator style.",
				["fr"] = "Ces fragments de livres permettent de fabriquer des objets au style de gladiateur des Terres mortes.",
			},
			["g"] = "/esoui/art/treeicons/gamepad/gp_lorelibrary_categoryicon_craftingstyle.dds",
			["n"] = 
			{
				["de"] = "Stil der Totenländer-Gladiatoren",
				["ru"] = "Стиль гладиатора Мертвых Земель",
				["en"] = "Deadlands Gladiator Style",
				["fr"] = "Style de gladiateur des Terres mortes",
			},
			["k"] = 181,
		},
		[83] = 
	...
	[3] = 
	{
		...
		[43] = 
		{
			...
			["d"] = 
			{
				["de"] = "Folianten, Briefe und andere Sendschreiben mit Bezug zu Feiern, Festlichkeiten und Wettbewerben oder sonstigen Ereignissen in ganz Tamriel.",
				["ru"] = "Книги, письма и прочие послания, связанные с торжествами, праздниками, конкурсами и другими событиями в Тамриэле.",
				["en"] = "Tomes, letters, and other missives relating to festivals, celebrations, contests, and other events happening throughout Tamriel.",
				["fr"] = "Volumes, lettres et autres missives concernant les festivals, fêtes, concours et autres événements organisés dans tout Tamriel.",
			},
			["g"] = "/esoui/art/icons/icon_missing.dds",
			["n"] = 
			{
				["de"] = "Katalog der Impressaria",
